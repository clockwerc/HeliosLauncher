...
The most up to date and accurate descriptions of the distribution spec can be viewed in [warcrime-distribution-types](https://github.com/dscalzi/warcrime-distribution-types).
